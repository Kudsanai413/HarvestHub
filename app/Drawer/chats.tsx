...
export default function Chats() {
    ...
    useEffect(() => {
        fetch(`${ database }/ChatMessages/messageID, recieverID,  createdAt, message/${ state.user.userID }`)
        .then(response => {
            if (!response.ok) throw new Error("Hameon Zvaitika");
  ...
  return (
    <>
        ...
        <View>
            ...
            <Button title='Get Chats' onPress={ () => {
